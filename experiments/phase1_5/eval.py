...
# Hardened selectivity primitives now live in core.eval_core (canonical source =
# phase1/eval_opcycle.py; phase1_5 held verbatim copies). Imported here so the names stay
# available to this module's adapters AND to phase1_5.tests.test_eval, which imports them
# from ``experiments.phase1_5.eval``. The phase1_5-specific adapters below
# (build_operation_labels, operation_consistency, regate_operation_selectivity,
# make_phase15_controls, selectivity_gate_phase15, …) stay here and call these.
from core.eval_core import (  # noqa: F401
    _adjusted_accuracy,
    chance_rate,
    geometry_baseline,
    probe_accuracy,
